...
def agent_view_customer():
	...
	if (data1 == None or data2 == None):
		...
		for i in range(len(data1)):
			...
			value1.append(temp_spend)
			customer_name.append(i+1)
			label1.append(data1[i]['customer_email'])
		...
		for i in range(len(data2)):
			...
			customer_spend.append(temp_spend)
			customer_name.append(i+1)
			value2.append(temp_spend)
			label2.append(data2[i]['customer_email'])
		plt.bar(customer_name, customer_spend, align='center', alpha=0.5)
		plt.xlabel('customer_name')
		...
		plt.savefig(file_path,dpi=400)
		print(label1,1)
		return render_template('agent_view_customer_result.html', data1 = data1, data2 = data2, label1=label1,label2=label2,value1=value1,value2=value2)
